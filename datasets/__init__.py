...
def get_input_transforms_wild(args, dataset):
    """
...
def setup_loaders(args):
    ...
    if 'cityscapes' in args.dataset:
        ...
        # train_joint_transform_list = [
        #     joint_transforms.Resize_hw((768, 768))]
    ...
    if 'gtav' in args.dataset:
        ...
        # train_joint_transform_list = [
        #     joint_transforms.Resize_hw((1280,720))]
    ...
    if 'synthia' in args.dataset:
        ...
        # train_joint_transform_list = [
        #     joint_transforms.Resize_hw((1280, 760))]
    ...
    if 'imagenet' in args.wild_dataset:
        dataset = imagenet
        imagenet_mode = 'val' ## Can be train val
        train_joint_transform_list, train_joint_transform = get_train_joint_transform_wild(args, dataset)
        train_input_transform, val_input_transform = get_input_transforms_wild(args, dataset)
    ...
    return train_loader, val_loaders, wild_loader, train_set, extra_val_loader, covstat_val_loader
